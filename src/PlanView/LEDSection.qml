...
Column {
    ...
    property alias exclusiveGroup:  ledColorSectionHeader.exclusiveGroup
    property alias showSpacer:      ledColorSectionHeader.showSpacer
    property alias checked:         ledColorSectionHeader.checked

    property var    _led:           missionItem.ledSection
    property real   _fieldWidth:    ScreenTools.defaultFontPixelWidth * 16
    property real   _margin:        ScreenTools.defaultFontPixelWidth / 2

    SectionHeader {
        id:             ledColorSectionHeader
        anchors.left:   parent.left
        anchors.right:  parent.right
        text:           qsTr("LED Color")
        checked:        false
    ...
    Column {
        ...
        anchors.right:  parent.right
        spacing:        _margin
        visible:        ledColorSectionHeader.checked
        QGCCheckBox {
            id:                 modeCheckBox
            text:               qsTr("Color")
            checked:            _led.specifyColor
            onClicked:          _led.specifyColor = checked
        }
        QGCSlider {
            id:             redSlider
            width:          200
